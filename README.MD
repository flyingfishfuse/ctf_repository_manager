...
# usage
    ...
    1. if you are running the tool outside of the context of this repository or not in the same
    ...
    ask for the location, provide a full system path to the config file.
